...
/**
 * cloned from PatternLayout
 */
public class RuntimePatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        defaultConverterMap.put("met", LevelConverter.class.getName());
